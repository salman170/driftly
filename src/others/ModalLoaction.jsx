...
const ModalLoaction = ({ visible, onClose }) => {
  ...
  return (
    ...
    >
      <div className="relative p-12 m-1 overflow-hidden text-center bg-white select-none lg:w-2/3 rounded-2xl">
        ...
        <div onClick={onClose} className="p-1.5  text-lg border rounded-full bg-[#f0f0f0] font-extralight w-min absolute top-4 right-4 cursor-pointer hover:shadow-lg">
          <AiOutlineClose />
        </div>
      </div>
    </div>
