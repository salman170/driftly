    ...
    <>
      <div className='container px-4 mx-auto mt-4'>
        <div className='grid items-center justify-center grid-cols-1'>
          ...
          <div className='flex items-center justify-center border border-gray-600 rounded'>
            <div className='grid grid-cols-5 gap-5 p-4'>
              ...
              <div className='flex items-center justify-center p-2 '>
                <MCDToggleButton />
                <div class='border border-r border-gray-300 h-full ml-12'></div>
                {/* <span className='p-1 text-white bg-black border border-black rounded-3xl'>
                  exterior
                </span>
                <span className='p-1 border border-black rounded-3xl'>
                  Interior
                </span> */}
              </div>
              <div className='flex items-center justify-center p-2 '>
                <span className='p-2 border border-gray-400 rounded-lg'>+</span>
                &nbsp; &nbsp;&nbsp;&nbsp;Zoom&nbsp; &nbsp; &nbsp;
                <span className='p-2 border border-gray-400 rounded-lg'>-</span>
              </div>
            </div>
...
const CarMainSpecs = () => {
  return (
    <div className='container px-4 mx-auto m-9'>
      <div className='flex items-center justify-center mt-4 border border-gray-600 rounded'>
        <div className='flex p-4 space-x-11'>
          <div className='flex items-center justify-center flex-grow flex-shrink-0 p-2'>
...
const CarSummary = () => {
  return (
    <div className='container px-4 mx-auto'>
      <div className='mt-9'>
        <div className='text-4xl text-gray-500 font-extralight'>
          Car Summary
        </div>
    ...
    <div className='container px-4 mx-auto m-9'>
      ...
      <div class='flex flex-wrap border rounded mt-6'>
        ...
        <div class='w-full p-4 flex items-center bg-gray-100 justify-center'>
          {' '}
          <p className='p-2 italic font-light text-gray-400 text-xxs'>
...
const ServiceHistory = () => {
  return (
    <div className='container px-4 mx-auto m-9'>
      <div className='text-4xl text-gray-500 font-extralight mt-9'>
        Service History
      </div>
    ...
    <div className='container px-4 mx-auto m-9'>
      <div class='mt-6 flex'>
        <div class='flex-1'>
          ...
          <div className='mt-4 text-lg'>Included with Vehicle</div>
          <div class='flex  mt-1 '>
          ...
          <div className='mt-4 text-lg'>Optional Protection Plans</div>
          <div class='flex mt-1 '>
            <div class='flex-1 border p-2'>
              <div class='flex flex-col'>
    ...
    <div className='p-2 bg-gray-100'>
      <div className='m-9'>
        <div className='container px-4 mx-auto bg-gray-100'>
          ...
          <div className='flex '>
            <div className='flex-1 mx-2 overflow-hidden bg-white border rounded-md shadow-md'>
              ...
              <div className='flex justify-between m-2'>
                <div className='m-2 text-xl text-black text-semibold'>
              ...
              {/* row 2 */}
              <div className='flex justify-between m-2'>
                <div className='p-2 text-sm font-light text-gray-600'>
                  {/* Content for the left cell goes here */}
                  Vehicle Price
                </div>
              ...
              {/* row 8 */}
              <div className='flex justify-between m-2'>
                <div className='p-2 text-xl text-black text-semibold'>
                  {/* Content for the left cell goes here */}
                  Other
                </div>
              ...
              {/* row 10 */}
              <div className='flex justify-between m-2'>
                <div className='m-2 text-2xl font-light text-gray-900'>
                  {/* Content for the left cell goes here */}
                  Total
                </div>

                <div className='m-2 text-2xl font-bold text-gray-900 '>
            ...
            {/* column 2 */}
            <div className='flex-1 h-full mx-2 overflow-hidden bg-white border rounded-md shadow-md'>
              <div className='flex items-center m-6'>
                <img
                  className='mr-4'
                  src='https://images-saboomaruti-in.s3.ap-south-1.amazonaws.com/driftly/icons/pay-once.webp'
              ...
              <div className='flex flex-col m-2'>
                <div className='p-2 text-lg font-light text-gray-600'>
                  Estimated Price
                </div>
                <div className='p-2 text-4xl font-semibold'>₹ 12,000</div>
                <div className='p-2 mt-5 italic font-light text-gray-400 text-md'>
                  Get personalised down/monthly payments within 2 minutes, and
                  no impact to your credit score.
                </div>
                <div className='mt-2'>
                  <div className='flex items-center p-2 m-5 text-sm italic font-light text-gray-600'>
                    <span className='mr-2'>
                      <img
...
const ToggleSwitch = () => {
  return (
    <label className='relative flex items-center cursor-pointer select-none w-max'>
      <input
        type='checkbox'
        className='w-16 transition-colors bg-red-500 rounded-full appearance-none cursor-pointer h-7 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'
        defaultChecked
      />
      <span className='absolute text-xs font-medium text-white left-1'>
        {' '}
        Pass{' '}
      </span>
      <span className='absolute text-xs font-medium text-white right-1'>
        {' '}
        Fail{' '}
      </span>
      <span className='absolute w-10 transition-transform transform bg-gray-300 rounded-full h-7 right-7' />
    </label>
  );
};
