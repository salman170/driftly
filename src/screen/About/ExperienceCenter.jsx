  ...
  return (
    <>
      <div className='container mx-auto'>
        <div className='flex justify-between items-start gap-10 mt-20 p-2'>
          ...
          <select
            name=''
            id=''
            className='border border-black w-60 rounded p-2 ra-select'
          >
        ...
        <div className='flex mt-5 justify-start text-lg items-start gap-8 p-3'>
            ...
            <div class='flex-1'>
              <div className='overflow-hidden'>
                <div className='container mx-auto font-extralight'>
                  <div className='my-5 invisible'>Media Coverage</div>
                </div>
